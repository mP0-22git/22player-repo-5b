package com.kabouzeid.trebl.lastfm.rest;
    ...
    public static Interceptor createCacheControlInterceptor() {
        return chain -> {
            Request modifiedRequest = chain.request().newBuilder()
                    //crashfix lastfmrestclient illegal argument
                    //note: crash here possibly being caused due to formatting discrepancies in some languages.
