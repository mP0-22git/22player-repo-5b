...
import com.kabouzeid.trebl.adapter.AlbumCoverPagerAdapter;
 ...
 */
public class FlatPlayerAlbumCoverFragment extends AbsMusicServiceFragment implements ViewPager.OnPageChangeListener, MusicProgressViewUpdateHelper.Callback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_flat_player_album_cover, container, false);
    ...
    private void hideLyricsLayout() {
        lyricsLayout.animate().alpha(0f).setDuration(FlatPlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION).withEndAction(() -> {
    ...
    public void setLyrics(Lyrics l) {
        ...
        lyricsLayout.animate().alpha(1f).setDuration(FlatPlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);
    }
    ...
    public void onUpdateProgressViews(int progress, int total) {
        ...
        if (!oldLine.equals(line) || oldLine.isEmpty()) {
            ...
            lyricsLine1.animate().alpha(0f).translationY(-h).setDuration(FlatPlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);

            lyricsLine2.setAlpha(0f);
            lyricsLine2.setTranslationY(h);
            lyricsLine2.animate().alpha(1f).translationY(0f).setDuration(FlatPlayerAlbumCoverFragment.VISIBILITY_ANIM_DURATION);
        }
    }
