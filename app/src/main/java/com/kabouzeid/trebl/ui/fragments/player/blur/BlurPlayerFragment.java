...
import com.kabouzeid.trebl.adapter.song.PlayingQueueAdapter;
import com.kabouzeid.trebl.dialogs.LyricsDialog;
...
public class BlurPlayerFragment extends AbsPlayerFragment implements BlurPlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private BlurPlayerPlaybackControlsFragment playbackControlsFragment;
    private BlurPlayerAlbumCoverFragment blurPlayerAlbumCoverFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_blur_player, container, false);
    ...
    public void updateSongDetails(){
        songTitle.setText(MusicPlayerRemote.getCurrentSong().title);
        artistText.setText(MusicPlayerRemote.getCurrentSong().artistName);
        albumText.setText(MusicPlayerRemote.getCurrentSong().albumName);
    }

    private void setUpSubFragments() {
        playbackControlsFragment = (BlurPlayerPlaybackControlsFragment) getChildFragmentManager().findFragmentById(R.id.playback_controls_fragment);
        blurPlayerAlbumCoverFragment = (BlurPlayerAlbumCoverFragment) getChildFragmentManager().findFragmentById(R.id.player_album_cover_fragment);

        blurPlayerAlbumCoverFragment.setCallbacks(this);
    }

    private void setUpPlayerToolbar() {
        toolbar.inflateMenu(R.menu.menu_blur_player);
    ...
    private void setUpRecyclerView() {
        ...
        playingQueueAdapter = new PlayingQueueAdapter(
                ...
                R.layout.item_list_playing_queue,
                false,
                null);
    ...
    private void updateLyrics() {
        ...
        updateLyricsAsyncTask = new AsyncTask<Void, Void, Lyrics>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                lyrics = null;
                blurPlayerAlbumCoverFragment.setLyrics(null);
            ...
            protected void onPostExecute(Lyrics l) {
                lyrics = l;
                blurPlayerAlbumCoverFragment.setLyrics(lyrics);
                if (lyrics == null) {
                    if (toolbar != null) {
                        toolbar.getMenu().removeItem(R.id.action_show_lyrics);
                    }
    ...
    protected void toggleFavorite(Song song) {
        ...
        if (song.id == MusicPlayerRemote.getCurrentSong().id) {
            if (MusicUtil.isFavorite(getActivity(), song)) {
                blurPlayerAlbumCoverFragment.showHeartAnimation();
            }
            updateIsFavorite();
        }
    }
    ...
    private static abstract class BaseImpl implements Impl {
        protected BlurPlayerFragment fragment;

        public BaseImpl(BlurPlayerFragment fragment) {
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public PortraitImpl(BlurPlayerFragment fragment) {
            super(fragment);
        }
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            fragment.slidingUpPanelLayout.setPanelHeight(0);
            //note: Playing queue is now completely out of sight when collapsed
    ...
    private static class LandscapeImpl extends BaseImpl {
        public LandscapeImpl(BlurPlayerFragment fragment) {
            super(fragment);
        }
