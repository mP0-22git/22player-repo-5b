...
public class FlatPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            Animator containerAnimator = ViewUtil.createBackgroundColorTransition(fragment.playerContent, fragment.lastColor, newColor); //note: added playercontent as carousel effect was resulting in a blank space

            AnimatorSet animatorSet = new AnimatorSet();
            animatorSet.playTogether(backgroundAnimator, statusBarAnimator,containerAnimator);
