package com.kabouzeid.trebl.ui.fragments.mainactivity.folders;
...
import com.kabouzeid.trebl.adapter.SongFileAdapter;
...
import com.kabouzeid.trebl.misc.DialogAsyncTask;
import com.kabouzeid.trebl.misc.UpdateToastMediaScannerCompletionListener;
...
public class FoldersFragment extends AbsMainActivityFragment implements MainActivity.MainActivityFragmentCallbacks, CabHolder, BreadCrumbLayout.SelectionCallback, SongFileAdapter.Callbacks, AppBarLayout.OnOffsetChangedListener, LoaderManager.LoaderCallbacks<List<File>> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view1 -> setCurrentFragment(LibraryFragment.newInstance()));
    }
    ...
    private void setUpAppbarColor() {
        ...
        breadCrumbs.setBackgroundColor(Color.TRANSPARENT);
        breadCrumbs.setActivatedContentColor(color);
        breadCrumbs.setDeactivatedContentColor(color);
    }
